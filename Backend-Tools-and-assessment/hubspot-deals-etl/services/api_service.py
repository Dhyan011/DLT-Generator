...
class APIService:
    ...
    This class wraps the underlying HubSpot API for backward-compatibility
    with the scaffold. For new code, prefer using HubSpotAPIService directly.
    """
    ...
    def get_data(self, 
        ...
        try:
            ...
            # HubSpot CRM API v3 Deals endpoint
    ...
    def validate_token(self, access_token: str) -> bool:
        ...
        try:
            ...
            # HubSpot token validation via lightweight deals request (limit=1)
            url = f"{self.base_url}/crm/v3/objects/deals"
            params = {'limit': 1}
    ...
    def get_account_info(self, access_token: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # HubSpot account / portal info endpoint
